...
public class E05TwoDimArray02
{
	...
	public static void main(String[] args)
	{
		...
		/*
		 * 시나리오] 다음 절차에 따라 프로그램을 작성하시오. 1. 2차원 배열을 선언한다. 세로2, 가로4 2. 난수를 이용하여 배열을
		 * 초기화한다.(0~100사이) 3. 배열전체요소를 매개변수로 전달된 정수만큼 증가시킨다. 4. 증가되기 전, 후 배열을 출력한다. 5. 다음
		 * 메소드명으로 구현한다. twoDimPlus()
		 */
	...
	/*
	 * 배열을 출력하는 부분이 중복되기 때문에 이런경우 메소드
	 * 생성하여 호출헤주는것이 좋다
	 */
