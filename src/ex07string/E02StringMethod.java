...
public class E02StringMethod
{
	public static void main(String[] args)
	{
		...
		/*
		 * 2] charAt(인덱스) : 문자열에서 특정 index애 해당하는 문자
		 * 하나를 반환한다 index는 0부터 시작한다
		 */
		...
		/*
		 * 4] compareTo() : 두문자열을 첫번째 문자부터 순차적으로 비교하면서
		...
		/*
		 * endswith()
		 * :문자열이 특정 문자열로 끝나면 true,아니면false를 반환한다
		 * startwith()
		 * : 문자열이 특정 문자열로 끝나면 false,아니면true를 반환한다
		 */
		 ...
		 * printf()와 사용본은 동일하고 주로 웹어플리케이션(jsp)를
		 * 제작할때 사용된다
		 */
		...
		/*
		 * [시니리오] 주민등록번호를 indexOf를 사용하여 성별을 구분하는 프로그램을 작성하시오
		 */
		juminNum = "1234353-348795684";
		...
		System.out.println("java를 KOSMOS로 변경하기");
		System.out.println(str1.replace("java", "kosmo"));//kosmo로 변경됨
		
		/*
		 * split()
		 * :문자열을 구분자를 통해 분리해서 String타입의 배열로
		 * 반환한다 해당 구분자기 없는 겅우에는 크기가 1인 String배열로 반환한다
		 */
		String phoneNumber = "010-7479-6747";
