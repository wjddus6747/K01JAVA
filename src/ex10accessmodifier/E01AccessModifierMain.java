 ...
 * class명 앞에는 public과 default만 붙일수 있다
 */
...
public class E01AccessModifierMain
{
	...
	{
		System.out.println("E01AccessModifier1객체 생서 및 접근");

		/*
		 private으로 선언된 멤버는 동일한 패키지라 할지라도 접근이 불가능하다
		 해당 멤버는 덩일 클래스 내에서만 접근을 허용한다
		 
		 * private으로 선언된 멤버를 외부클레스에서 접근할때는 주로
		...
		/*
		 * 동일한 패키지에 선언된 클레스이므로 import없이 객체생성및 접근이 가능하다
		 */
	...
	//////////////////////////////////////////////////////////////////////
		...
		System.out.println("E01AccessModifier2객체 생서 및 접근");

		/*
		 * 다른패키지에서 선언된 클레스이므로 객체생성을 위해서는 import가 필요하다
