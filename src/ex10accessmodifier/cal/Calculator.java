...
/*
 * Calculator클래스는 해당 java파일에서 외부에 가장 의미있는
 * 클래스로써 public으로 선언되었다
 * 자바에서는 하나의 class만 public으로 선언하는것이 가능하다
 * public으로 선언된 클레스에서 default클래스를 사용하는 형태로 제작되어야 한다
 */
public class Calculator
{
	 ...
	 * 정보은닉되어있는 멤버변수의 출력을 위해 getter()메소드를 호출하고 있다.
	 */
