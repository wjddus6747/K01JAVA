...
public class DeChild extends DeParent
{
	...
	public void study()
	{
		System.out.println(getName() + "이가 공부한다");
	}
	/*
	 * 오버라이딩 아님. 
	...
	public int walk(int age) {
		System.out.println("나이가"+ age + "살이 학생이"+ "산채한다");
		return 0;
	}
