...
class A{
	...
	public void loadMethod() {
		System.out.println("A의 load method");
	}
...
class B extends A{
	...
	public void loadMethod(int num) {
		System.out.println("B의 load metho");
	}
}
class C extends B{
	@Override
	...
	public void loadMethod(double num) {
		System.out.println("C의 load metho");
	}
}
public class E07RideAndLoad01
{
	...
	public static void main(String[] args)
	{
		...
		/*
		  ...
		  호출된다. 즉 아래부분은 모두 C클레스에 셍성된 메소드가 호출된다.
		 */
