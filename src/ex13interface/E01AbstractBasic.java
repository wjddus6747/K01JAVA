...
{	//int형으로 표현할수 았는 최대값을 반환하는 Wrapper클래스
...
{	//자식클래스애서 확장한 변수와 메소드
	...
	void instanceMethod()
	{
		System.out.println("필요없ㄷ아면 오버라이딩 하지 않아도 상관없다.");
	}
}
 ...
 * 정의해야한다. class앞에  abstract를 지우면 에러가 발생한다
 */
...
class absClassChild2 extends absClass2
{
	...
	{
		System.out.println("부모클래스에서 오버라이딩한 메소드로 없을땐 에러발생");
	}
...
public class E01AbstractBasic
{
	...
	public static void main(String[] args)
	{
		...
		다운케스팅(강제형변환) 후 접근해야한다.
		*/

		/*
		 * 추상클래스내에 선언된 정적멤버는 오버라이딩의 대상이
		 * 될수 없으므로 static이 가진 기본규칙을 따른다.
		 * 클래스명으로 접근한다.
		 */
