 ...
 * 추상메소드
 * - 오버라이딩의 목적으로 만들어진다.
 * - 함수의 실행부가 없기 때문에 {} 를 쓰지않고 함수의 원형에 ;을 붙여준다.
 */

//프로젝트 전체에 기준이 될 수 있는 추상클래스 정의
 ...
 */
class PersonalNumberStorageExt extends PersonalNumberStorage
{
	// 멤버변수
	PersonalInfoDTO[] personalArr;// 정보저장용 객체 배열
	int numOfPerInfo = 0;// 입력정보 카운트용변수
	// 생성자
	...
	/*
	 * 전달받은 인자를 통해 personalInfoDTO객체를 생성후 객체배열에 저장한다.
	 */
	@Override
	...
	/*
	 * 주민번호를 인자로 전달받아 객체배열에 저장된 정보를 검색한후 일치하는 경우에만 이름을 반환한다.
	 */
	@Override
...
public class E02AbstractToInterface1
{
	...
	{
		PersonalNumberStorageExt storg = new PersonalNumberStorageExt(10);

		//정보저장
		storg.addPersonalInfo("39482-3473847", "이정연");
		storg.addPersonalInfo("2384435-3473847", "이준승");

		//검색
		System.out.println(storg.searchPersonalInfo("39482-3473847"));
		System.out.println(storg.searchPersonalInfo("2384435-3473847"));
		System.out.println(storg.searchPersonalInfo("456564-3473847"));
	}
