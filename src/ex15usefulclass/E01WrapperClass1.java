...
public class E01WrapperClass1
{
	...
	public static void main(String[] args)
	{
		...
		/*
		 * Wrapper클래스를 사용하는 이점
		 * : Wrapper클래스에 정의된 많은 메소드를 사용할수 있다.
		...
		/*
		 * 자바의 모든 클래스는 Object클레스를 상속받는다.
		 * 그러므로 아래 메소드를 사용할수 있다.
		 * 
		 * toString() : 인스턴스변수를 출력시 참조값이 아니라
		 * 실제 저장된 값을 문자열 형태로 반환해주는 메소드
		 * hashCode():객체를 구별하기 위해 참조값을 고유한 정수값으로 반환해주는 매소드
		 */
		...
		System.out.println(numObj1.toString()+1);
