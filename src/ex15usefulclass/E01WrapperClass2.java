...
public class E01WrapperClass2
{
	...
	public static void main(String[] args)
	{
		 ...
		 */
		String money = "120원";
		//System.out.println("120원:"+ Integer.parseInt(money)); //에러발생
		...
		/*
		 4] isLatter() : 문자여부를 판단하는 메소드로 특수기호나 숫자형은 false를 반환한다.
		 */
		System.out.println("isLatter()메소드를 통한 문자판단");
		...
		/*
		 6] 대소문자를 판단하는 메소드 
		 		: 영문자에만 적용되며 알파뱃이 아닌경우 false를 반환한다.
