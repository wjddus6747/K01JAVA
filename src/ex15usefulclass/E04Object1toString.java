 ...
 * Object 클래스
 * -자바에서의 최상의 클래스이다
 * -별도의 선언없이 Object클래스에 정의된 모든 메소드를 사용할수 있다.
 * -개발자가 정의한 모든 클래스를 Object인스턴스로 참조 할 수 있다.
 * 
...
/*
  * toString()메소드
 * - Object클래스에 정의된 메소드로 println()이 문자열을 출력하기전에 자동으로 호출하는 메소드이다.
...
public class E04Object1toString
{
	...
	public static void main(String[] args)
	{
		...
		myFriends fnd1 = new myFriends("이정연");
		yourFriends fnd2 = new yourFriends("이준승");
		
		System.out.println(fnd1);//이름이 출력됨
		System.out.println(fnd2);//인스턴스의 주소값이 츨력됨
