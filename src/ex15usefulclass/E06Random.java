...
public class E06Random
{
	...
	{
		/*
		 * 컴퓨터 인자로 전달되는 Seed(씨앗)울 기반으로 난수를 생성한다.
		...
		System.out.println("###난수생성3: 항상 다른seed 사용");
		...
		System.out.println("###난수생성4: 항상 다른seed 사용, nextInt() 인자 없음");
		Random random4 = new Random();
		//현재 시간을 밀리 초 단위로 반환하는 메소드
		random4.setSeed(System.currentTimeMillis());
		for(int i=0; i<10; i++) {
			/*
			 * nextInt()에 인자값이 없는경우에는 음수, 양수가 횬용되어 난수가 생성된다.
			 */
