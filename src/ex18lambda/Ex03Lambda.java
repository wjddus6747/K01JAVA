...
/*
 람다식(Lambda Exception)
 	: 객체지향에서는 메소드를 사용하기 위해서응 반드시 클래스를 정의한후
 	메소드를 선언해야 한다. 이러한 불편함 때문에 최근 함수형프로그래밍(Functional Programming)
 	의 장점이 대두되었고, 이런 단점을 보완하기 위해 JDK1.8부터 지원하게 되었다.
 */
...
public class Ex03Lambda
{
	public static void main(String[] args)
	{
		...
		/*
		 ...
		 -매개변수가 하나라면 소괄호 생략가능
		 -실행문장이 하나이고, 동시에 return문이 아니라면 중괄호 생략가능
		 */
