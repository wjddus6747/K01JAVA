...
public class Ex06Define1Predicate
{
	...
	public static void main(String[] args)
	{
		/*
		  ...
		  : 전달된 인자를 대상으로 true, false를 판단할때 사용하는 추상메소드를 정의하고 있다.
		  	test메소드 항상 생각하기
		 */
		...
		/*
		 Predicate<Human> 인터페이스를 구현하여 정의한 람다식.
		 test() 추상메소드를 오버라이딩 하고 있다.
		 */
		...
		Human p3 = new Human("이정연", "여자", 97);
		Human p4 = new Human("이준승", "남자", 50);
		
		//일반적인 배열에 List컬렉션으로 변경해주는 메소드
		...
		List<Integer> list = Arrays.asList(1,5,7,8,4,55,41,7);
	...
	public static double avg(Predicate<Human> ph, List<Human> li) {
		int pCount =0; //전달된 객채의 성별에 따라 인원수를 카운트
