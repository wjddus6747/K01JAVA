...
public class Ex06Define4Function
{
	...
	public static void main(String[] args)
	{
		...
		System.out.println("Lambda문자열길이="+ func.apply("Lambda"));
		System.out.println("LambdaExpression 문자열 길이="+ func.apply("LambdaExpression"));
		
		System.out.println("=============================");
		
		Human p1 = new Human("이정연", "여자", 100);
		Human p2 = new Human("이주연", "남자", 80);
		Human p3 = new Human("이준승", "여자", 70);
		Human p4 = new Human("남시현", "남자", 65);
		List<Human> list = Arrays.asList(p1,p2,p3,p4);
		
		//Human 객체를 매개값으로 받아서 점수를 반환하는 람다식.
